...
public class HttpRequest {
    ...
    private void appendHeaderParameter(String header) throws MalformedURLException {
        int idx = header.indexOf(":");
        if (idx == -1) {
            throw new MalformedURLException("Некорректно задан заголовок HTTP-запроса: " + header);
        }
